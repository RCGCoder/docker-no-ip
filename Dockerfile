...
RUN set -x
RUN chmod a+rwX /noip-client/files
RUN tar -C /noip-client/files -x -f /noip-client/files/noip-duc-linux.tar.gz noip-2.1.9-1/binaries/noip2-x86_64
RUN mv /noip-client/files/noip-2.1.9-1/binaries/noip2-x86_64 /noip-client/files
RUN rm -rf /files/noip-2.1.9-1 /files/noip-duc-linux.tar.gz
